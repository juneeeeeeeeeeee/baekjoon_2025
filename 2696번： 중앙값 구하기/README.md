...
<p>중앙값보다 작은 것은 최대힙, 큰 것은 최소힙에 넣는다. 2개씩 진행했을 때, 최대힙과 최소힙의 개수를 비교하면 같거나, 둘 중 하나가 2개가 많다. 같은 경우는 중앙값을 유지하고, 둘 중 하나의 힙이 2개가 많은 경우 힙을 이동시켜 중앙값을 변화시킨다. 
출력이 귀찮은 문제이다. </p>
