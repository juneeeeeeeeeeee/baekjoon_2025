# 1967번: 트리의 지름 - `<img src="https://static.solved.ac/tier_small/12.svg" style="height:20px" />` Gold IV
...
<p>1번 node에서 거리가 가장 먼 곳은 무조건 지름 중 한 점임을 이용한다. 1번 node에서 DFS를 돌리고, 가장 멀리 있는 점에서 DFS를 돌려 전체 트리의 지름을 구한다. </p>
