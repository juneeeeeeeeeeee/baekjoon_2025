# 11505번: 구간 곱 구하기 - `<img src="https://static.solved.ac/tier_small/15.svg" style="height:20px" />` Gold I
...
<p>세그먼트 트리 문제이다. 다른 것보다 이전에 0이 있는 경우 update를 해야 하는 부분이 어려웠다. 이전의 값이 0인 경우 0으로 나눌 수 없기 때문에 이전 값으로 나누고 새로운 값으로 곱하는 것이 불가능하며, 따라서 세그먼트 트리를 처음 만드는 것처럼 재귀를 해야 한다. </p>
